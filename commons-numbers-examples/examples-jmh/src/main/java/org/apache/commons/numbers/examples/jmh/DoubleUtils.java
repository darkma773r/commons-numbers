...
public final class DoubleUtils {
     ...
     */
    public static double random(final int minExp, final int maxExp, final UniformRandomProvider rng) {
     ...
     */
    public static double[] scalarMultiply(final double[] v, final double s) {
