 ...
 */
public class PlaneAngle_Old {
    /** Zero. */
    public static final PlaneAngle_Old ZERO = new PlaneAngle_Old(0);
    /** Half-turn (aka &pi; radians). */
    public static final PlaneAngle_Old PI = new PlaneAngle_Old(0.5);
    /** Conversion factor. */
     ...
     */
    private PlaneAngle_Old(double value) {
        this.value = value;
    }
     ...
     */
    public static PlaneAngle_Old ofTurns(double angle) {
        return new PlaneAngle_Old(angle);
    }
     ...
     * @return a new intance.
     */
    public static PlaneAngle_Old ofRadians(double angle) {
     ...
     * @return a new intance.
     */
    public static PlaneAngle_Old ofDegrees(double angle) {
        return new PlaneAngle_Old(angle * FROM_DEGREES);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof PlaneAngle_Old) {
            return Double.doubleToLongBits(value) ==
                    Double.doubleToLongBits(((PlaneAngle_Old) other).value);
        }
        return false;
    }
     ...
     */
    public static final class Normalizer implements UnaryOperator<PlaneAngle_Old> {
        /** Lower bound. */
         ...
         */
        @Override
        public PlaneAngle_Old apply(PlaneAngle_Old a) {
            if (a.value < lowerBound || a.value >= upperBound) {
                ...
                return normalized < upperBound ?
                    ...
                    new PlaneAngle_Old(normalized - 1);
            }
     ...
     */
    public static Normalizer normalizer(PlaneAngle_Old center) {
        return new Normalizer(center);
    }

    private static final class PlaneAngleOfRadians extends PlaneAngle_Old {
